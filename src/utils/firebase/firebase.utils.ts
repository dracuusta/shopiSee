...
export const createUserDocumentFromAuth=async(userAuth:any,additionalInfo?:any)=>{
  if(!userAuth)
  return ;
...
export const createrAuthUserWithEmailAndPassword=async(email:string,password:string)=>{
